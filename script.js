...
function sortearCarta() {
    ...
    cartas.splice(numeroCartaMaquina,1); /* tira o indice do elemento*/
...
function exibeCartaJogador() {
    ...
    for(var atributo in cartaJogador.atributos) {
		let atributoLabel = atributo + " " + cartaJogador.atributos[atributo];
        opcoesTexto += "<input onclick='enableStartButton()' type='radio' name='atributo' value='" + atributo + "' id='" + atributo + "'>"
		opcoesTexto += "<label for='" + atributo + "'>" + atributoLabel + "</label> <br>";
    }
